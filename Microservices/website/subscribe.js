...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (link){
      fetch(`https://api.ivandeveric.site/fortune/subscribe`, {
        ...
        .then(data => {
            document.getElementById("subscribe-status").textContent=data.message;
        ...
        .catch(error => {
            document.getElementById("subscribe-status").textContent="The used link is invalid, please recheck.";
